...
13. Создать [класс с Инкапсуляцией методов и наследованием по диаграмме]. https://github.com/cp58ngygcaqo/Animals
14. Написать [программу, имитирующую работу реестра домашних животных]. https://github.com/cp58ngygcaqo/Animals
...
15. Создайте [класс Счетчик]https://github.com/cp58ngygcaqo/Animals, у которого есть метод add(), увеличивающий̆
